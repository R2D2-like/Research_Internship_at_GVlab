...
# load path
vae_encoder_path = '/root/Research_Internship_at_GVlab/data0402/sim/model/vae_encoder.pth' # VAEのエンコーダーの重みへのパス
vae_data_path = '/root/Research_Internship_at_GVlab/data0402/real/step1/data/exploratory_action_preprocessed.npz'
...
# save path
dir = '/root/Research_Internship_at_GVlab/data0402/real/model/proposed/'
