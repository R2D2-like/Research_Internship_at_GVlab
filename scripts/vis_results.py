        ...
        if mode == 'step2':
            ...
            if method == '0':
                if p_or_r == '0':
                    ...
                    data_path = '/root/Research_Internship_at_GVlab/data0328/real/rollout/data/baseline/result/' + save_name +'_retake.npz'
                ...
                if p_or_r == '0':
                    ...
                    kp = float(input('kp:'))
                    data_path = '/root/Research_Internship_at_GVlab/data0328/real/rollout/data/proposed/result/' + save_name +'_kp{}.npz'.format(kp)
                    save_dir = save_dir + 'proposed/result/'
            if not os.path.exists(save_dir):
                os.makedirs(save_dir)
            save_path = save_dir + save_name +'_kp{}.png'.format(kp)
        if p_or_r == '0':
